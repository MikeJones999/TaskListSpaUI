                            ...
                            <nav className="flex w-full flex-col gap-1 p-2 sm:p-3">
                                ...
                                >
                                    ...
                                    <div className="flex-shrink-0 flex items-center gap-2">
                                        ...
                                        <button
                                            className="rounded-md border border-transparent p-1.5 sm:p-2 text-center text-sm transition-all text-slate-600 hover:bg-slate-200 focus:bg-slate-200 active:bg-slate-200 disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
                                            type="button"
