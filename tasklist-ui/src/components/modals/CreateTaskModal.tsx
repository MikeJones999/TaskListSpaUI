...
export default function CreateTaskModal({ onClose, onSuccess: onSuccessRefreshLists, item }: EditDeleteTaskModalConfrimationProps) {
    {
        ...
        const handleSubmit = async (e: React.FormEvent) => {
            ...
            try {
                ...
                const response = await apiRequest<ResponseDto>("ToDoItems", {
                    method: "POST",
